...
% inter-semispace pointers. With the addition of this invariant,
% copying correctness does become a bit more specialised, but it can
% simply be ignored to work with other moving collectors. Sadly, the
% properties checked aren't quite what I used in my proofs, as doing
% that would have required making a copy of the heap before garbage
% collection and then comparing the two heaps. I did not do this,
% however it would have been possible, as I deliberately restricted
% the size of the heap in order to force a large number of garbage
% collections.
