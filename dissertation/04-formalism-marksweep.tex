...
given a \gls{pointer}, $p$, let $\gchead{p}$ return a pointer to the
start of the \gls{garbage collection} metadata.
...
$\lnot\free{c} \iff \left(\ldots\right)$, but this would then require the
